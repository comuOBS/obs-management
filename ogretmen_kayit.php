...
$token='c35dede6bd63f5e382c540ff08558dec42a9a973';
    ...
    $dizi['user'] = $user_id;
    $dizi['degree'] = $_POST["derece"];
    $dizi['room_number'] = $_POST["oda"];
    $dizi['phone'] = $_POST["tel"];
    $dizi['fax'] = $_POST["fax"];
    $dizi['address'] = $_POST["adres"];
    $dizi['gender'] = $_POST["cinsiyet"];
    $dizi['department'] = $_POST["department_code"];
	$response=postApi($token,'http://127.0.0.1:8000/lecturers/?format=json',$dizi,'post');

    
	header("Location:http://localhost/obs_management/?path=ogretmen_ekle");
