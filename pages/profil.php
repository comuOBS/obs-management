<?php 
	...
	$lecturers_json=getApi($user_token,'http://127.0.0.1:8000/managements/?format=json');
	...
	for($i=0;$i<$lecturers_json["count"];$i++)
	{
		if($lecturers_json["results"][$i]["user"]==$user_id)
		{
            ...
            $management_id=$users_json["results"][$i]["id"];
		}
	}
	
	for($i=0;$i<$departments_json["count"];$i++)
	{
		if(intval($departments_json["results"][$i]["id"])==intval($department_id))
		{
                          ...
                          <div class="panel-body">
                              <div class="tab-content">
                                  ...
                                  <div id="edit-profile" class="tab-pane">
                                    <section class="panel">                                          
                                          <div class="panel-body bio-graph-info">
                                              <h1> Yöetici Bilgileri Güncelleme</h1>
                                              <form class="form-horizontal" role="form" id="updateProfileLecturer" name="updateProfileLecturer" action="javascript:updateProfileLecturer();" method="post" >                                                  
                                                  ...
                                                  <input type="hidden" name="management_id" id="management_id" value="<?php echo "$management_id" ?>">
