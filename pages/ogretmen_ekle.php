...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-file-text-o"></i> Öğretim Görevlisi Ekleme</h3>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                             Öğretim Görevlisi Bilgileri Giriş
                          </header>
                          <div class="panel-body">
                              <form class="form-horizontal " action="ogretmen_kayit.php" method="post">
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Derecesi</label>
                                      <div class="col-sm-10">
                                          <input type="text" name="derece" class="form-control">
                                      </div>
                                  </div>
                                  <div class="form-group">
